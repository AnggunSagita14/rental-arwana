...
$totalPengembalian = $conn->query("
SELECT COUNT(*) as total
FROM pengembalian
")->fetch(PDO::FETCH_ASSOC);

$totalTerlambat = $conn->query("
SELECT COUNT(*) as total
FROM pengembalian
WHERE status_pengembalian='TERLAMBAT'
")->fetch(PDO::FETCH_ASSOC);

$totalTepat = $conn->query("
SELECT COUNT(*) as total
FROM pengembalian
...
<div class="title">
    ...
    <p>Kelola data pengembalian rental mobil</p>
...
if($row['status_pengembalian'] == "TERLAMBAT"){
...
function editPengembalian(button){
    ...
    let terlambat =
    kolom[3].innerText.replace("Hari","").trim();

    if(terlambat.includes("Tepat Waktu")){
